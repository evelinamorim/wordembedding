...
dir_data="/home/evelinamorim/Documentos/UFMG/wordembedding/data/out_tmp/"
...
ans <- read.csv("/home/evelinamorim/Documentos/UFMG/wordembedding/sa/analise/ans.csv", header = FALSE)
# ans[docid_list]
proc.time() - ptm
...
# multilinear regression: buidilng model
reg <- lm( sat_y ~ X + Y)
